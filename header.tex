...
\documentclass[
	...
	ngerman,					% LANGUAGE deutsches Dokument, fÃ¼r Umlaute, Silbentrennung etc. (Umlauts, Hyphenation)
	a4paper,					% paper size
...
\newcommand{\thesistitle}{Konzeptionierung und Implementierung einer intelligenten Ladestation in einer diskreten eventbasierten Simulationsumgebung}
\newcommand{\thesistype}{Bachelorarbeit}
\newcommand{\autor}{Ludwig Breitsprecher}
\newcommand{\mail}{ludwig.breitsprecher@tu-ilmenau.de}
\newcommand{\courseofstudies}{Wirtschaftsinformatik}
\newcommand{\matriculationnr}{54131}
\newcommand{\supervisor}{Prof. Dr. Armin Zimmermann}
\newcommand{\secondtutor}{M.Sc. Thomas Dietrich}
\newcommand{\faculty}{Fakult�t f�r Informatik und Automatisierung}
\newcommand{\department}{System- und Software-Engineering}
\newcommand{\location}{Ilmenau}
\newcommand{\registrationdate}{05.~Oktober 2017}
\newcommand{\submissiondate}{05.~Januar 2018}
\newcommand{\submissiontimestamp}{05.01.2018}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\iic}{\mbox{I\texttwosuperior C}} % IÂ²C
