...
In der Tabelle \ref{tab:Auswertung Anforderungen} ist zu sehen, dass alle nicht funktionalen Anforderungen erledigt wurden. Darüber sind im Bereich der funktionalen Anforderungen die beiden wichtigsten Kategorien \lstinline|MUST| und \lstinline|SHOULD| vollständig abgearbeitet und erfüllt. Lediglich die zwei Anforderungen aus der Kategorie \lstinline|COULD| und die eine Anforderung aus der Kategorie \lstinline|WON`T| bleiben unerledigt. Gemäß der MoSCoW-Methode war die Implementierung erfolgreich. 
